<div class="modal-header">
    <h3 class="modal-title" id="modal-title">AngularJs Validation</h3>
</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
					        ...
					        <div class="error" ng-messages="myform.confirm_password.$error" ng-if=" myform.confirm_password.$dirty">
					          ...
					          <p ng-message="passwordVerify">Password do not match</p>
					        </div>						
						</div>
					</div><br>

					<div class="modal-footer">
			            <button class="btn btn-primary" type="submit" ng-click="submited('myform')">Submit</button>
